...
<body>
    ...
    document.addEventListener('DOMContentLoaded', function() {
        // Set currency symbol
        document.getElementById('currencySymbol').textContent = currencySymbols['CAD'];
    });
    ...
    function calculateEMI() {
        ...
        if (loanAmount < 1000 || loanAmount > 3000000) {
            alert('Loan amount must be between 1,000 and 3,000,000 CAD');
            return;
        }
        ...
        const currencySymbol = currencySymbols['CAD'];
