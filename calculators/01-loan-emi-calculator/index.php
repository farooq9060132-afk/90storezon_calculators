...
$countries = [
    ...
    'india' => [
        ...
        'loan_types' => ['Home Loan', 'Car Loan', 'Personal Loan', 'Gold Loan']
    ],
    'usa' => [
        'name' => 'USA',
        'currency' => '$',
        'flag' => 'https://flagcdn.com/w80/us.png',
        'loan_types' => ['Mortgage', 'Auto Loan', 'Student Loan', 'Personal Loan']
    ],
    'uk' => [
        'name' => 'United Kingdom',
        'currency' => '£',
        'flag' => 'https://flagcdn.com/w80/gb.png',
        'loan_types' => ['Mortgage', 'Car Finance', 'Personal Loan', 'Student Loan']
    ],
    'uae' => [
        'name' => 'UAE',
        'currency' => 'AED',
        'flag' => 'https://flagcdn.com/w80/ae.png',
        'loan_types' => ['Home Loan', 'Auto Loan', 'Personal Loan', 'Business Loan']
    ],
    'canada' => [
        'name' => 'Canada',
        'currency' => 'C$',
        'flag' => 'https://flagcdn.com/w80/ca.png',
        'loan_types' => ['Mortgage', 'Auto Loan', 'Personal Loan', 'Student Loan']
    ],
    'australia' => [
        'name' => 'Australia',
        'currency' => 'A$',
        'flag' => 'https://flagcdn.com/w80/au.png',
        'loan_types' => ['Home Loan', 'Car Loan', 'Personal Loan', 'Investment Loan']
    ]
];
?>
<!DOCTYPE html>
...
<head>
    ...
    <title>International Loan Calculator</title>
...
<body>
    ...
    <section class="hero-section">
        <div class="hero-content">
            <h1 class="hero-title">International Loan Calculator</h1>
            <p class="hero-subtitle">Calculate your loan EMI for different countries with accurate currency conversion</p>
            ...
            <?php foreach($countries as $country_code => $country_data): ?>
                <a href="<?php echo $country_code; ?>.php" class="country-card">
                    ...
                    <div class="loan-types">
                        <?php foreach($country_data['loan_types'] as $loan_type): ?>
                            <span class="loan-type"><?php echo $loan_type; ?></span>
                        <?php endforeach; ?>
                    </div>
                </a>
            <?php endforeach; ?>
    ...
    <section class="features-section">
        ...
        <div class="features-grid">
            <div class="feature-card">
                ...
                <p class="feature-description">Calculate loans for multiple countries with their specific currencies and regulations</p>
            </div>
            ...
            <div class="feature-card">
                ...
                <p class="feature-description">Tailored calculations for each country's loan types and interest rates</p>
            </div>
        </div>
    </section>
